...
type internal Initial() =
  ...
  override this.Up(migrationBuilder: MigrationBuilder) =
    migrationBuilder.CreateTable(
      ...
      constraints =
        (fun table ->
          table.PrimaryKey("PK_BlockTypes", (fun x -> (x.BlockTypeId) :> obj))
          |> ignore)
    )
    |> ignore
      ...
      columns =
        (fun table ->
          {| CreatorId =
             ...
             BotState =
               table.Column<Core.BotState>(nullable = true, ``type`` = "jsonb") |}),
      constraints =
        (fun table ->
    ...
    migrationBuilder.InsertData(
      table = "BlockTypes",
      columns = [| "BlockTypeId"; "BlockTypeName" |],
      values =
        array2D [ [ 0 :> obj; "Text" :> obj ]
                  [ 1 :> obj; "Voice" :> obj ] ]
    )
    |> ignore

    migrationBuilder.CreateIndex(
      name = "IX_BlockTypes_BlockTypeName",
      table = "BlockTypes",
      column = "BlockTypeName",
      unique = true
    )
    |> ignore
  ...
  override this.Down(migrationBuilder: MigrationBuilder) =
    ...
    migrationBuilder.DropTable(name = "BlockTypes")
    |> ignore
